...
- Actions explicitly not supported first: SES console-only workflows, account billing, quota purchase flows, and managed cross-region failover controls outside `ses:CreateEmailIdentity` and its paired read/list calls.
