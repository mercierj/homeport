...
- Runtime/provisioning: provision `RabbitMQ delayed jobs` with generated `artifacts/compat/gcp/cloud-tasks/backend.yaml`, health endpoint, persistence volume, backup job, endpoint route, and teardown script for `gcp/cloud-tasks`.
