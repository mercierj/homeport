...
func (r *Registry) RegisterDefaults() {
	...
	r.Register(compute.NewSageMakerMapper())
	...
	r.Register(compute.NewComprehendMapper())
	...
	r.Register(security.NewAWSConfigMapper())
	r.Register(security.NewOrganizationsMapper())
	r.Register(security.NewControlTowerMapper())
	...
	r.Register(messaging.NewStepFunctionsMapper())
	r.Register(messaging.NewMQMapper())
	r.Register(messaging.NewIoTCoreMapper())
