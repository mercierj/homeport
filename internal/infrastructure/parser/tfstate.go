...
func mapTerraformTypeToResourceType(tfType string) resource.Type {
	...
	case "aws_comprehend_document_classifier", "aws_comprehend_entity_recognizer":
		return resource.TypeComprehendClassifier
	...
	case "aws_wafv2_web_acl", "aws_waf_web_acl":
	...
	case "aws_iot_thing", "aws_iot_topic_rule":
		return resource.TypeIoTThing
	...
	case "aws_cloudformation_stack":
		return resource.TypeCloudFormationStack
