...
func mapAWSTerraformType(tfType string) resource.Type {
	mapping := map[string]resource.Type{
		...
		"aws_comprehend_document_classifier":       resource.TypeComprehendClassifier,
		"aws_comprehend_entity_recognizer":         resource.TypeComprehendClassifier,
		...
		"aws_securityhub_account":                resource.TypeSecurityHubAccount,
		...
		"aws_controltower_control":               resource.TypeControlTowerControl,
