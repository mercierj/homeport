...
func mapAzureTerraformType(tfType string) resource.Type {
	mapping := map[string]resource.Type{
		...
		"azurerm_container_registry":      resource.TypeAzureContainerRegistry,
		"azurerm_cognitive_account":       resource.TypeAzureFoundryOpenAI,
		...
		"azurerm_databricks_workspace":    resource.TypeAzureDatabricks,
