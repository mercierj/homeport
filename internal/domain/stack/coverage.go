...
var ResourceMapping = map[resource.Type]StackType{
	...
	resource.TypeControlTowerControl:       StackTypePassthrough, // Landing-zone guardrails stay explicit policy controls
